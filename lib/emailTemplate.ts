        ...
        <div class="footer">
            ...
            <div class="social-links">
                ...
                <a href="https://linkedin.com/company/${linkedin}" class="social-link" title="Follow us on LinkedIn" target="_blank">
                    <img src="https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/linkedin.svg" alt="LinkedIn" width="20" height="20" style="display: block; width: 20px; height: 20px; filter: brightness(0) invert(1);" />
                </a>
            </div>
        </div>
    </div>
